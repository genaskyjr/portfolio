function About(){
    return(
        <section className="mt-12 p-5 bg-[#424C6F] border rounded-lg border-0 mx-2
        sm:mx-12 md:mx-24 lg:mx-36">
            ...
            sm:text-sm md:text-base lg:text-lg">I graduated with a <span className="text-[#76BFE8] font-extrabold">Computer Science Degree</span> from <span className="text-[#76BFE8] font-extrabold">Don Honorio Ventura State University</span>. With a proven passion for web development, 
